<!-- Table Substation Contact Numbers-->
<div class="container" style="margin-top:10px;"SSS>
  <div class="row">
    <div class="col-md-4 form-inline" style="float:right; padding: 10px 0px 10px 0px;">
      <div class="form-group">
        <input type="text" id="search_sub" class="form-control input-sm" placeholder="Search Substation" onkeyup="listSubstation()">
      </div>
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-lg-12" >
      <div class="table-responsive">
        ...
        <div id="table_substation_error" style="display:none;text-align:center;color:#a94442;"><b>NO RESULTS FOUND!</b></div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header modal-header-success">
            <a href="#" data-dismiss="modal" aria-hidden="true" class="close">×</a>
            <h2 class="header"><i class="glyphicon glyphicon-thumbs-up"></i> Substation Information</h2>
        </div>
        <div class="modal-body">
